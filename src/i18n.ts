...
export const messages: Record<Locale, Messages> = {
  zh: {
    ...
    output_format: '输出格式',
    output_quality: '输出质量',
    estimated_output: '预计输出尺寸',
    total_pixels: '{pixels} 像素',
    clear: '清空图片',
    remove: '移除',
    start_stitch: '开始拼接',
    start_cut: '开始切割',
  ...
  ja: {
    ...
    output_format: '出力形式',
    output_quality: '画質',
    estimated_output: '推定出力サイズ',
    total_pixels: '{pixels} ピクセル',
    clear: '画像をクリア',
    remove: '削除',
    start_stitch: '画像を結合',
    start_cut: '画像を分割',
  ...
  ko: {
    ...
    output_format: '출력 형식',
    output_quality: '품질',
    estimated_output: '예상 출력 크기',
    total_pixels: '{pixels} 픽셀',
    clear: '초기화',
    remove: '삭제',
